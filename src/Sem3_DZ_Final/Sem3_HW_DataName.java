...
public class Sem3_HW_DataName {
    private static final int fields_number = 6;

    public static void main(String[] args) {
        System.out.println("Введите данные через пробел в формате: (Фамилия Имя Отчество) (дата_рождения:dd.mm.yyyy) (номер_телефона) (пол:m/f)");
